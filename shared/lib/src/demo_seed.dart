...
Compound buildDemoCompound() {
  ...
  return Compound(
    ...
    nowPlaying: NowPlaying(
      ...
      positionSeconds: 0.42 * 28 * 60,
      isPlaying: true,
    ),
    mediaStats: MediaLibraryStats(movieCount: 214, showCount: 38, episodeCount: 1642),
    continueWatching: [
      ContinueWatchingItem(id: 'cw1', title: 'The Bear', durationSeconds: 28 * 60, positionSeconds: 0.42 * 28 * 60),
      ContinueWatchingItem(id: 'cw2', title: 'Dune: Part Two', durationSeconds: 166 * 60, positionSeconds: 0.18 * 166 * 60),
      ContinueWatchingItem(id: 'cw3', title: 'Fallout', durationSeconds: 55 * 60, positionSeconds: 0.75 * 55 * 60),
      ContinueWatchingItem(id: 'cw4', title: 'Shogun', durationSeconds: 58 * 60, positionSeconds: 0.6 * 58 * 60),
      ContinueWatchingItem(id: 'cw5', title: 'Civil War', durationSeconds: 109 * 60, positionSeconds: 0.05 * 109 * 60),
      ContinueWatchingItem(id: 'cw6', title: 'The Boys', durationSeconds: 62 * 60, positionSeconds: 0.88 * 62 * 60),
    ],
